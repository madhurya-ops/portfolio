    ...
    <div className="w-full px-2 mb-6 relative z-30">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative z-30">
        {images.map((image, index) => (
          <PictureCard key={index} src={image.src} alt={image.alt} />
        ))}
      </div>
    </div>
  );
    ...
    <div className="w-80 flex-shrink-0 mx-2">
      <div className="relative flex size-full max-w-lg flex-col gap-3 overflow-hidden rounded-lg border border-neutral-800 p-4 backdrop-blur-md bg-white/5 hover:bg-white/10 transition-colors duration-200 h-full">
        ...
        <div className="flex flex-row justify-between tracking-tight">
          ...
          {/* Updated X Icon using next/image */}
          <Image
            src="/x.svg"
            alt="X (Twitter) Icon"
            width={20}
    ...
    <div className="mb-6">
      ...
      >
        ...
        <div className="flex">
          ...
          {[...tweets, ...tweets, ...tweets, ...tweets, ...tweets].map(
            (tweet, index) => (
...
/**
 * Overlay component with a fixed background
 */
const LandingOverlay = () => (
  <div className="absolute inset-0 w-full h-full z-20 [mask-image:radial-gradient(transparent,white)] pointer-events-none bg-neutral-950" />
);
          ...
          <div className="w-full px-2 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[0, 1].map((index) => (
                <div
                  key={index}
                  className="relative overflow-hidden rounded-xl bg-white/5 backdrop-blur-md border border-neutral-800"
                >
