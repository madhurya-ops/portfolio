...
const imageConfig: ImageData[] = [
  { src: "/pic1.jpg", w: 300, h: 400, aspectRatio: "300 / 400", gridClass: calculateGridClass(300, 400), priority: true },
  { src: "/pic2.jpg", w: 600, h: 800, aspectRatio: "600 / 800", gridClass: calculateGridClass(600, 800), priority: true },
  { src: "/pic10.jpg", w: 600, h: 800, aspectRatio: "600 / 800", gridClass: calculateGridClass(600, 800), priority: true },
  { src: "/pic4.jpg", w: 300, h: 400, aspectRatio: "300 / 400", gridClass: calculateGridClass(300, 400), priority: false },
  { src: "/pic6.jpg", w: 300, h: 720, aspectRatio: "300 / 720", gridClass: calculateGridClass(300, 720), priority: false },
  { src: "/pic7.jpg", w: 300, h: 400, aspectRatio: "300 / 400", gridClass: calculateGridClass(300, 400), priority: false },
  { src: "/pic8.jpg", w: 300, h: 300, aspectRatio: "300 / 300", gridClass: calculateGridClass(300, 300), priority: false },
  { src: "/pic9.jpg", w: 300, h: 585, aspectRatio: "300 / 585", gridClass: calculateGridClass(300, 585), priority: false },
  { src: "/pic11.jpg", w: 900, h: 400, aspectRatio: "900 / 400", gridClass: calculateGridClass(900, 400), priority: false }
];
